        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <div class="flex items-center gap-4 mt-1">
                    ...
                    <span class="text-sm font-semibold text-gray-600 bg-gray-100 px-3 py-1 rounded-md border border-gray-200">
                        Calculated Cost: Rp {{ number_format($minCost, 0, ',', '.') }} - Rp {{ number_format($maxCost, 0, ',', '.') }}
                    </span>
        ...
        <div x-show="activeTab === 'assignment'" x-cloak>
            ...
            <div class="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-lg flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-xs text-gray-500">Determine the final selling price for this package after reviewing the calculated cost.</p>
                </div>
