...
@section('content')
    <div class="relative w-full h-screen overflow-hidden bg-gray-900" x-data="{ menuOpen: false }">
        ...
        <div class="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
            <p class="text-sm md:text-base uppercase tracking-[0.3em] font-semibold text-gray-300 mb-4 drop-shadow-md">The
                Wedding Of</p>
            ...
            <h2 class="font-serif text-3xl md:text-4xl mt-16 tracking-widest uppercase drop-shadow-xl text-white/90">Welcome
                Guests!</h2>
        </div>
        ...
        <div class="absolute bottom-8 left-8 z-50">
            ...
            <div x-show="menuOpen" @click.away="menuOpen = false" x-transition:enter="transition ease-out duration-200"
                ...
                <a href="{{ route('crew.rsvp.guests.create', $event->id) }}"
                    ...
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M18 9v3m0 0v3m0-3h3m-3 0h-3m2 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    Input New Guest
                </a>
